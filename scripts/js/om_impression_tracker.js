/**
 * This script tracks BURL impression when PUC is used with the specified PUC tag data's property
...
;(function (omidGlobal, factory, exports) {
    ...
    var module$exports$omid$common$constants = {
        ...
        AdSessionType: {NATIVE: "native", HTML: "html", JAVASCRIPT: "javascript"},
    ...
    var module$exports$omid$common$DetectOmid = {
        OMID_PRESENT_FRAME_NAME: "omid_v1_present", isOmidPresent: function (a) {
            try {
    ...
    var module$contents$omid$complianceVerificationScript$ComplianceVerificationClient_AdEventTypeArray = [
            module$exports$omid$common$constants.AdEventType.IMPRESSION
        ],
        module$exports$omid$complianceVerificationScript$ComplianceVerificationClient = function (a, b) {
            var c = this;
    ...
    module$exports$omid$complianceVerificationScript$ComplianceVerificationClient.prototype.fireEvent_ = function (a) {
        ...
        var urls = window.prebidImpressionUrlArray;

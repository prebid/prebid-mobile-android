...
modules=("PrebidMobile" "PrebidMobile-core" "PrebidMobile-gamEventHandlers" "PrebidMobile-mopubAdapters" "PrebidMobile-admobAdapters" "PrebidMobile-maxAdapters")
extensions=("jar" "aar" "jar" "jar" "jar" "jar")
for n in ${!modules[@]}; do
  echo -e "\n"

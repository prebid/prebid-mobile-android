...
/**
 * Config class sets the Config parameters like storedRequestId, priceGanularity.
...
public class ConfigSettings {
    ...
    public static void setPriceGranularity (PriceGranularity priceGranularity) { ConfigSettings.priceGranularity = priceGranularity; }

...
import static com.openx.apollo.video.vast.VASTErrorCodes.MEDIA_DISPLAY_ERROR;
...
public class ExoPlayerView extends PlayerView implements VideoPlayerView {
    ...
    private final Player.EventListener mEventListener = new Player.EventListener() {
        ...
        public void onPlayerError(ExoPlaybackException error) {
            mVideoCreativeViewListener.onFailure(new AdException(AdException.INTERNAL_ERROR, MEDIA_DISPLAY_ERROR.toString()));
        }

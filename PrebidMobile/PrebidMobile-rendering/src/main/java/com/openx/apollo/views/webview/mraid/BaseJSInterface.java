...
import com.openx.apollo.mraid.methods.MraidEventHandlerNotifierRunnable;
...
import com.openx.apollo.utils.broadcast.MraidOrientationBroadcastReceiver;
...
import com.openx.apollo.utils.helpers.MraidUtils;
...
import static com.openx.apollo.networking.parameters.GeoLocationParameterBuilder.LOCATION_SOURCE_GPS;
    ...
    public String getLocation() {
        ...
        if (locationInfoManager.isLocationAvailable()) {
            try {
                ...
                location.put(LOCATION_TYPE, LOCATION_SOURCE_GPS);

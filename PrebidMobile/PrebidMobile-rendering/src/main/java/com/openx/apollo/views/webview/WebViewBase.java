...
import static com.openx.apollo.views.webview.AdWebViewClient.AdAssetsLoadedListener;
import static com.openx.apollo.views.webview.PreloadManager.PreloadedListener;
...
public class WebViewBase extends AdWebView implements AdAssetsLoadedListener {
    ...
    private PreloadedListener mPreloadedListener;
    ...
    public WebViewBase(Context context, String html, int width, int height, PreloadedListener preloadedListener, MraidEventsManager.MraidListener mraidInterface) {
        super(context);
    ...
    public WebViewBase(Context context, PreloadedListener preloadedListener, MraidEventsManager.MraidListener mraidHelper) {
        super(context);
        mPreloadedListener = preloadedListener;
    ...
    public void loadAd() {
         ...
         * via-javascript
         * ***/
        loadDataWithBaseURL(ApolloSettings.getWebViewBaseUrlScheme() + "://" + mDomain + "/", mAdHTML,
    ...
    public PreloadedListener getPreloadedListener() {

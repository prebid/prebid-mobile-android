...
import com.openx.apollo.models.openrtb.bidRequests.devices.Geo;
import com.openx.apollo.models.openrtb.bidRequests.imps.Banner;
import com.openx.apollo.models.openrtb.bidRequests.imps.Video;
...
import static com.openx.apollo.networking.parameters.BasicParameterBuilder.KEY_OM_PARTNER_NAME;
import static com.openx.apollo.networking.parameters.BasicParameterBuilder.KEY_OM_PARTNER_VERSION;
import static com.openx.apollo.networking.parameters.BasicParameterBuilder.VIDEO_INTERSTITIAL_PLAYBACK_END;
...
public class BasicParameterBuilderTest {
    ...
    public void cleanup() throws Exception {
        ...
        ApolloSettings.sendMraidSupportParams = true;
        ApolloSettings.useExternalBrowser = false;
        ApolloSettings.isCoppaEnabled = false;
    }
    ...
    public void whenAppendParametersAndSendMraidSupportParamsFalse_NoMraidApi() {
        ...
        ApolloSettings.sendMraidSupportParams = false;
    ...
    private BidRequest getExpectedBidRequest(AdConfiguration adConfiguration, String uuid) {
        ...
        bidRequest.getExt().put("prebid", Prebid.getJsonObjectForBidRequest(ApolloSettings.getAccountId(), isVideo));
        //if coppaEnabled - set 1, else No coppa is sent
        if (ApolloSettings.isCoppaEnabled) {
    ...
    private Imp getExpectedImp(AdConfiguration adConfiguration, String uuid) {
        ...
        imp.displaymanagerver = ApolloSettings.SDK_VERSION;
        ...
        // 0 == embedded, 1 == native
        imp.clickBrowser = !ApolloSettings.useExternalBrowser && mBrowserActivityAvailable ? 0 : 1;
        imp.id = uuid;

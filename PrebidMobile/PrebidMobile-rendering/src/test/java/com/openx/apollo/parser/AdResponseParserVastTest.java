...
import com.openx.apollo.video.vast.HTMLResource;
import com.openx.apollo.video.vast.InLine;
import com.openx.apollo.video.vast.StaticResource;
import com.openx.apollo.video.vast.Tracking;
import com.openx.apollo.video.vast.Verification;
...
public class AdResponseParserVastTest {
    ...
    public void testGetAllTrackings() throws Exception {
        ...
        AdResponseParserVastHelper tempVast = new AdResponseParserVastHelper(vastXML);
        ArrayList<com.openx.apollo.video.vast.Tracking> expectedTrackings = new ArrayList<>();
        ...
        ArrayList<com.openx.apollo.video.vast.Tracking> actual = tempVast.getAllTrackings(vast, 0);

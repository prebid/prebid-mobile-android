...
public class PrebidCustomEventSettings {
    ...
    // MoPub constants
    static final String MOPUB_WIDTH = "com_mopub_ad_width";
    static final String MOPUB_HEIGHT = "com_mopub_ad_height";
    // Facebook constants
    ...
    static final String FACEBOOK_AD_ERROR_CLASS = "com.facebook.ads.AdError";
        ...
        switch (demand) {
            case FACEBOOK:
                try {
                    ...
                    Class<?> adErrorClass = Class.forName(FACEBOOK_AD_ERROR_CLASS);

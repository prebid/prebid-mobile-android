...
@Deprecated
public class MoPubNativeMediationUtils_old extends MoPubBaseMediationUtils {
    ...
    public MoPubNativeMediationUtils_old(HashMap<String, String> keywords, MoPubNative nativeView) {

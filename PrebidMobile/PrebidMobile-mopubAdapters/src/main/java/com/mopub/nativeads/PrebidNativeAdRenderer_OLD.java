...
// TODO: Remove
@Deprecated
public class PrebidNativeAdRenderer_OLD implements MoPubAdRenderer<PrebidNativeAdWrapper_Old> {
    ...
    public PrebidNativeAdRenderer_OLD(
    ...
    public boolean supports(
        ...
        return nativeAd instanceof PrebidNativeAdWrapper_Old;
    }
    ...
    private void update(
            @NonNull final StaticNativeViewHolder staticNativeViewHolder,
            @NonNull final PrebidNativeAdWrapper_Old adWrapper) {

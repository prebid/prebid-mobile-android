...
public class AdBasePage<T> extends BasePage<T> {
    ...
    private static final int OPENX_PAGE_TIMEOUT = 20000;
    ...
    private static class Locators {
        ...
        static UiSelector openXPageTitle = new UiSelector().text("OpenX");
    ...
    @SuppressWarnings("unchecked")
    public T openXPageShouldOpen() throws UiObjectNotFoundException {
        return clickOnElementByUiSelector(Locators.openXPageTitle, OPENX_PAGE_TIMEOUT);
    }

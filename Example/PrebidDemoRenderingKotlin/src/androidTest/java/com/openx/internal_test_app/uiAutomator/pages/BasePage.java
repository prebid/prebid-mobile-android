...
public class BasePage<T> {
    ...
    protected static final String TAG = "com.openx.internal_test_app";
    ...
    public T switchBackToOpenX() {
        if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
            return pressBackToApp();
        }
        openRecentApps();
        device.wait(Until.findObject(getWebViewSelectorVersionDepends("OpenX SDK Internal Test App")), 100).click();
        return (T) this;
    }

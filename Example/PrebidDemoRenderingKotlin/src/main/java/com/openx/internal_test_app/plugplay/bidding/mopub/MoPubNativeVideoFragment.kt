...
class MoPubNativeVideoFragment : MopubNativeFragment() {
    ...
    override fun initAd() {
        ...
        val apolloAdRenderer = ApolloNativeAdRenderer(viewBinder)
        apolloAdRenderer.setMediaViewResId(R.id.mediaView)
        apolloAdRenderer.setMediaViewListener(mediaViewListener)

        mopubNative?.registerAdRenderer(apolloAdRenderer)

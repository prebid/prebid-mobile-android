...
class InAppDisplayRewardedActivity : BaseAdActivity() {
    ...
    private fun createAd() {
        adUnit = RewardedAdUnit(this, CONFIG_ID, EnumSet.of(AdUnitFormat.BANNER))
        adUnit?.setRewardedAdUnitListener(object : RewardedAdUnitListener {
            ...
            override fun onUserEarnedReward(rewardedAdUnit: RewardedAdUnit?, reward: Reward?) {
                Log.d("InAppDisplayRewarded", "User earned reward: $reward")
            }
        })
        adUnit?.loadAd()
    }

...
class AppLovinMaxDisplayRewardedActivity : BaseAdActivity() {
    ...
    private fun createAd() {
        ...
        adUnit?.fetchDemand { result ->
            Log.d("MaxRewarded", "Prebid demand fetch result: $result")
            if (result != FetchDemandResult.SUCCESS) {
                Log.d("MaxRewarded", "Continuing with MAX waterfall fallback.")
            }
